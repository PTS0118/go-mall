...
func (x *CreateProductResp) fastReadField3(buf []byte, _type int8) (offset int, err error) {
...
func (x *Product) fastWriteField7(buf []byte) (offset int) {
	...
	offset += fastpb.WriteInt32(buf[offset:], 7, x.GetStock())
	return offset
}
...
func (x *CreateProductResp) fastWriteField3(buf []byte) (offset int) {
	if x.ProductId == 0 {
		return offset
	}
	offset += fastpb.WriteInt32(buf[offset:], 3, x.GetProductId())
	return offset
}
...
func (x *Product) sizeField7() (n int) {
	...
	n += fastpb.SizeInt32(7, x.GetStock())
	return n
}
...
func (x *CreateProductResp) sizeField3() (n int) {
	if x.ProductId == 0 {
		return n
	}
	n += fastpb.SizeInt32(3, x.GetProductId())
	return n
}
