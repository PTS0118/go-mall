...
func (x *GetUserReq) fastReadField3(buf []byte, _type int8) (offset int, err error) {
	x.Email, offset, err = fastpb.ReadString(buf, _type)
	return offset, err
}
...
func (x *GetUserReq) fastWriteField3(buf []byte) (offset int) {
	if x.Email == "" {
		return offset
	}
...
func (x *GetUserReq) sizeField3() (n int) {
	if x.Email == "" {
		return n
	}
